...
import * as SC from './LogPage.styled';
import { useGetVisitorsQuery } from '../../redux/logVisitirs/logVisitirs';
...
export const LogPage = () => {
  const { data, isLoading } = useGetVisitorsQuery(null);
  ...
  return (
    <SC.VisitorsList>
      {isLoading && <Loader />}
      {data &&
        data.map(({ country, ipAddress, timestamp, url, password, email }) => {
